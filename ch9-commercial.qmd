# Economic/Commercial Beliefs {#sec-economic-commercial}
...
# Calculate average perceived and normalize to 100%
avg_perceived <- wealth_data %>%
  ...
  mutate(
    pct = pct / sum(pct) * 100,  # Normalize to 100%
    quintile_label = c("Top 20%", "2nd 20%", "3rd 20%", "4th 20%", "Bottom 20%"),
    type = "Perceived"
  )

# Calculate average desired and normalize to 100%
